...
int main() {
  ...
  // Example of traversals with a complete tree of integers
  {
    ...
    std::cout << "Example of pre-order traversal with a complete tree: "
              << std::endl;
    ...
    std::cout << "Example of in-order traversal with a complete tree: "
              << std::endl;
    ...
    std::cout << "Example of post-order traversal with a complete tree: "
              << std::endl;
  ...
  // Example from lecture: Traversals on an algebraic syntax tree.
  {
    ...
    ValueBinaryTree<std::string> algebra_tree(
        {"+", "-", "*", "a", "/", "d", "e"});
