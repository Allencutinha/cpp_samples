...
int longestPalindromeLength(
    const std::string& str, int leftLimit, int rightLimit, timeUnit startTime, double maxDuration)
{
    ...
    int leftSubproblemResult =
        longestPalindromeLength(str, leftLimit, rightLimit - 1, startTime, maxDuration);
    // Move the left limit to the right.
    int rightSubproblemResult =
        longestPalindromeLength(str, leftLimit + 1, rightLimit, startTime, maxDuration);
